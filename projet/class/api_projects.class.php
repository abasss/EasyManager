 ...
 */
class Projects extends MounirApi
{
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->project->create(MounirApiAccess::$user) < 0) {
    ...
    */
    ...
    public function put($id, $request_data = null)
    {
        ...
        if ($this->project->update(MounirApiAccess::$user) >= 0)
        {
            return $this->get($id);
        }
        else
    ...
    public function delete($id)
    {
        ...
        if ( ! $this->project->delete(MounirApiAccess::$user)) {
    ...
    public function validate($id, $notrigger = 0)
    {
        ...
        $result = $this->project->setValid(MounirApiAccess::$user, $notrigger);
        if ($result == 0) {
