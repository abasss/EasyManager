...
{
	global $user,$conf,$langs,$mounir_main_db_name;
	...
	$menu_arr[] = array(
		...
		//'link' => '/societe/list.php?type=c&leftmenu=customers',
		'title' => "ThirdParties",
		'level' => 0,
		'enabled' => $showmode = isVisibleToUserType($type_user, $tmpentry, $listofmodulesforexternal),
		'target' => $atarget,
	...
	for($i = 0; $i < $num; $i++)
	{
		...
		if ($showmode == 1)
		{
		    ...
		    // url = url from host, shorturl = relative path into mounir sources
...
/**********************************************************************************************************************************************/
	if ($showmode == 1) {
		...
		print '<div class="'.$id.' '.$idsel.' topmenuimage"><span class="'.$id.' tmenuimage" id="mainmenuspan_'.$idsel.'">';
		/**********************************************************************************************************************************************/
		print '<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
		/**********************************************************************************************************************************************/
		print '</span></div>';
...
{
	global $user, $conf, $langs, $mounir_main_db_name, $mysoc;
	...
	if (empty($conf->global->MAIN_MENU_INVERT) && empty($noout) && ! empty($conf->global->MAIN_SHOW_LOGO) && empty($conf->global->MAIN_OPTIMIZEFORTEXTBROWSER))
	{
		...
		{
			$urllogo=DOL_URL_ROOT.'/theme/mounir_logo.png';
		}
...
// abasssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss	
...
//				$newmenu->add("/admin/pdf.php?mainmenu=home", $langs->trans("PDF"), 1);
				...
				$newmenu->add("/admin/sms.php?mainmenu=home", $langs->trans("WhatsApp"), 1);
				$newmenu->add("/admin/sms.php?mainmenu=home", $langs->trans("FaceBook"), 1);
...
//				$newmenu->add("/admin/const.php?mainmenu=home", $langs->trans("OtherSetup"), 1);
			...
			if ($usemenuhider || empty($leftmenu) || preg_match('/^admintools/', $leftmenu))
			{
                ...
                $langs->loadLangs(array('admin', 'help'));
/* abass
				$newmenu->add('/admin/system/mounir.php?mainmenu=home&amp;leftmenu=admintools_info', $langs->trans('InfoMounir'), 1);
...
*/
				$newmenu->add("/admin/tools/mounir_export.php?mainmenu=home&amp;leftmenu=admintools", $langs->trans("Backup"), 1);
				$newmenu->add("/admin/tools/mounir_import.php?mainmenu=home&amp;leftmenu=admintools", $langs->trans("Restore"), 1);
/* abass
