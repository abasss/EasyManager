...
?>
// Javascript libraries for ERP ERP CRM (https://www.google.com)
 ...
 * http://matelli.fr/showcases/patchs-mounir/update-date-input-in-action-form.html)
 * Licence: GPL
 * ==================================================================
 */
	...
	$.widget( "ui.combobox", {
        ...
        _create: function() {
            ...
            var input = this.input = $( "<input>" )
                ...
                .addClass( "ui-widget ui-widget-content ui-corner-left mounircombobox" );
