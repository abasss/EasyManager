...
class InterfaceStripe
{
    ...
    public function __construct($db)
    {
        ...
        $this->version = 'mounir'; // 'development', 'experimental', 'mounir' or version
	...
	{
		// Put here code you want to execute when a ERP business event occurs.
