 ...
 */
class InterfaceLogevents extends MounirTriggers
{
	/**
	...
	public $description = "Triggers of this module allows to add security event records inside ERP.";
	...
	/**
	 * Function called when a Mounirr security audit event is done.
