 ...
 */
class InterfaceLdapsynchro extends MounirTriggers
{
	public $family = 'ldap';
	public $description = "Triggers of this module allows to synchronize ERP toward a LDAP database.";
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		if ($action == 'USER_CREATE')
		{
			...
			if (! empty($conf->global->LDAP_SYNCHRO_ACTIVE) && $conf->global->LDAP_SYNCHRO_ACTIVE === 'mounir2ldap')
			{
				$ldap=new Ldap();
