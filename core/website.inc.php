...
if ($_SERVER['PHP_SELF'] != DOL_URL_ROOT.'/website/index.php')	// If we browsing page using ERP server or a Native web server
{
...
if (! defined('USEMOUNIREDITOR') && empty($website->status))
{
