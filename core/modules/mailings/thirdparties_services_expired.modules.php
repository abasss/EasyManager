...
{
    public $name='MounirContractsLinesExpired';
    ...
    public function __construct($db)
    {
        ...
        if ($result)
        {
            ...
            dol_syslog("mounir_services_expired.modules.php:mailing_mounir_services_expired ".$num." services found");
    ...
    public function getNbOfRecipients($sql = '')
    {
        ...
        // Example: return parent::getNbOfRecipients("SELECT count(*) as nb from mounir_table");
        // Example: return 500;
