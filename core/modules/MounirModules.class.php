...
/**
 * \file           htdocs/core/modules/MounirModules.class.php
 ...
 */
class MounirModules // Can not be abstract, because we need to instantiate it into unActivateModule to be able to disable a module whose files were removed.
{
    /**
     ...
     * @see https://www.google.com/index.php/List_of_modules_id
     */
    public $numero;
     ...
     * 'development'
     * 'experimental'
     * 'mounir': only for core modules that share its version
     * 'mounir_deprecated': only for deprecated core modules
     */
    public $version;
    ...
    /**
     * @var array Minimum version of ERP required by module.
     * e.g.: ERP ≥ 3.6 = array(3, 6)
     */
    public $need_mounir_version;
    ...
    // We should but can't set this as abstract because this will make mounir hang
     ...
     * For 'mounir' modules, gives ERP version
     *
    ...
    {
        if ($this->version == 'mounir' || $this->version == 'mounir_deprecated') {
            return 'core';
        }
     ...
     * The init function adds tabs, constants, boxes, permissions and menus (defined in constructor) into ERP database.
     ...
     * The remove function removes tabs, constants, boxes, permissions and menus from ERP database.
