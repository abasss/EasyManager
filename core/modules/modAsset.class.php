 ...
 */
class modAsset extends MounirModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Use here a free id (See in Home -> System information -> ERP for list of used modules id).
		$this->numero = 51000;		// TODO Go on page https://www.google.com/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->descriptionlong = "Assets module to manage assets module and depreciation charge on ERP";

		// Possible values for version are: 'development', 'experimental', 'mounir', 'mounir_deprecated' or a version string like 'x.y.z'
		...
		$this->need_mounir_version = array(7,0);	// Minimum version of ERP required by module
	 ...
	 *  The init function add constants, boxes, permissions and menus (defined in constructor) into ERP database.
