 ...
 */
require_once DOL_DOCUMENT_ROOT . "/core/modules/MounirModules.class.php";


/**
 * Description and activation class for module Ticket
 */
class modTicket extends MounirModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        // Use a free id here
        // (See in Home -> System information -> ERP for list of used modules id).
        $this->numero = 56000;
