...
/**
 *	Classe permettant la gestion monkey des codes personne
 */
class mod_codeclient_monkey extends ModeleThirdPartyCode
{
	...
	public $prefixIsRequired; // Le champ prefix du personne doit etre renseigne quand on utilise {pre}
	...
	/**
	 *		Renvoi si un code est pris ou non (par autre personne)
	 *
