 ...
 *  \brief      Module to make generic import of data into mounir database
 ...
 */
class modImport extends MounirModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "Outils d'imports de donnees ERP (via un assistant)";
		...
		$this->phpmax = array();
		$this->need_mounir_version = array(2,7,-1);	// Minimum version of ERP required by module
