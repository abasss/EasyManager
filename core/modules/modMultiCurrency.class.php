 ...
 */
class modMultiCurrency extends MounirModules
{
	/**
    ...
    public function __construct($db)
    {
		...
		// Possible values for version are: 'development', 'experimental', 'mounir' or 'mounir_deprecated' or version
		$this->version = 'mounir';
		...
		$this->need_mounir_version = array(3, 0); // Minimum version of ERP required by module
