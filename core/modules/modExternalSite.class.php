 ...
 * \brief      Module to include an external web site/tools into ERP menu and into a frame page.
 ...
 */
class modExternalSite extends MounirModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "This module include an external web site or page into ERP menus and view it into a ERP frame.";
