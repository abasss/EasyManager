...
// The class name should start with a lower case mod for ERP to pick it up
// so we ignore the Squiz.Classes.ValidClassName.NotCamelCaps rule.
// @codingStandardsIgnoreStart
/**
 *  Description and activation class for module datapolicy
 */
class modDataPolicy extends MounirModules {
    ...
    public function __construct($db)
    {
        ...
        $this->need_mounir_version = array(4, 0); // Minimum version of ERP required by module
