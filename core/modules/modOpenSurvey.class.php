 ...
 */
class modOpenSurvey extends MounirModules
{
    ...
    public function __construct($db)
    {
		...
		// Use here a free id (See in Home -> System information -> ERP for list of used module id).
		$this->numero = 55000;
		...
		// Possible values for version are: 'development', 'experimental', 'mounir' or version
		$this->version = 'mounir';
		...
		$this->need_mounir_version = array(3,4,0);	// Minimum version of ERP required by module
