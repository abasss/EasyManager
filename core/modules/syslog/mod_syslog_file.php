...
class mod_syslog_file extends LogHandler implements LogHandlerInterface
{
	...
	/**
	 * Version of the module ('x.y.z' or 'mounir' or 'experimental' or 'development')
	 *
	 * @return string
	 */
	...
	public function export($content, $suffixinfilename = '')
	{
		...
		if (! $filefd)
		{
			...
			{
				// Do not break mounir usage if log fails
				//throw new Exception('Failed to open log file '.basename($logfile));
				print 'Failed to open log file '.($mounir_main_prod?basename($logfile):$logfile);
			}
		}
		else
		{
