 ...
 */
class modHRM extends MounirModules
{
	/**
	 * Constructor.
	...
	public function __construct($db)
	{
		...
		$this->need_mounir_version = array (3,9); // Minimum version of ERP required by module
	 ...
	 * (defined in constructor) into ERP database.
