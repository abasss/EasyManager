...
$titleofloginpage=$langs->trans('Login').' @ '.$titletruemounirversion;	// $titletruemounirversion is defined by dol_loginfunction in security2.lib.php. We must keep the @, some tools use it to know it is login page and find true mounir version.
...
<?php
if ($disablenofollow) echo '<a class="login_table_title" href="https://www.audoune.com" target="_blank">';
