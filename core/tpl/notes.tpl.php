...
if (! empty($conf->fckeditor->enabled) && ! empty($conf->global->FCKEDITOR_ENABLE_SOCIETE)) $typeofdata='ckeditor:mounir_notes:100%:200::1:12:95%:0';	// Rem: This var is for all notes, not only thirdparties note.
