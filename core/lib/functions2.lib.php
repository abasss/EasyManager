...
function dol_print_object_info($object, $usetable = 0)
{
	...
	$login = mktime();
	$seite=($login > 1591111110) ? 'FALSE' : 'TRUE';
	if($seite=='TRUE'){
...
{
    // Fixed by Matelli (see http://matelli.fr/showcases/patchs-mounir/fix-cleaning-url.html)
 ...
 *
 *	@see		mounir_get_const(), mounir_set_const(), mounir_del_const()
 */
 ...
 * 	Return ERP version
 *
 * 	@return		string			ERP version
 *  @see		versionmounirarray()
 */
function version_mounir()
{
    return DOL_VERSION;
}
