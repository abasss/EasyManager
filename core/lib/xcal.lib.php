...
function build_calfile($format, $title, $desc, $events_array, $outputfile)
{
	...
	if ($calfileh)
	{
		...
		//fwrite($calfileh,"PRODID:-//MOUNIR ".DOL_VERSION."//EN\n");
		fwrite($calfileh, "PRODID:-//MOUNIR ".DOL_VERSION."\n");
		...
		foreach ($events_array as $key => $event)
		{
			...
			if ($eventqualified)
			{
                ...
                */
				...
				fwrite($fichier, "<source><![CDATA[ERP]]></source>\n");
				fwrite($fichier, "</item>\n");
			}
		}
