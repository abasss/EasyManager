...
class DolEditor
{
     ...
     *  @param 	string	$toolbarname	       		 	Name of bar set to use ('Full', 'mounir_notes[_encoded]', 'mounir_details[_encoded]'=the less featured, 'mounir_mailings[_encoded]', 'mounir_readonly').
    ...
    public function __construct($htmlname, $content, $width = '', $height = 200, $toolbarname = 'Basic', $toolbarlocation = 'In', $toolbarstartexpanded = false, $uselocalbrowser = true, $okforextendededitor = true, $rows = 0, $cols = 0, $readonly = 0)
    {
        ...
        if ($this->tool == 'fckeditor')
    	{
    		...
    		// ERP utilise toujours liens avec modulepart='fckeditor' quelque soit modulepart.
