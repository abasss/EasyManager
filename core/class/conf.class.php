...
class Conf
{
	...
	public function setValues($db)
	{
		...
		// conf->email_from = email pour envoi par mounir des mails automatiques
		...
		// conf->notification->email_from = email pour envoi par ERP des notifications
		...
		// conf->mailing->email_from = email pour envoi par ERP des mailings
