...
class Canvas
{
	...
	*/
	...
	public function getCanvas($module, $card, $canvas)
	{
		...
		// Set properties with value specific to mounir core: this->targetmodule, this->card, this->canvas
	...
	// http://www.google.com/index.php/Canvas_development
	 ...
	 * 	@see		http://www.google.com/index.php/Canvas_development
	 */
