...
class SMTPs
{
    ...
    public function getHeader()
    {
        ...
        */
        ...
        if ($trackid)
        {
            ...
            $_header .= 'Message-ID: <' . time() . '.SMTPs-mounir-'.$trackid.'@' . $host . ">\r\n";
            $_header .= 'References: <' . time() . '.SMTPs-mounir-'.$trackid.'@' . $host . ">\r\n";
            $_header .= 'X-ERP-TRACKID: ' . $trackid . '@' . $host . "\r\n";
        }
        else
        {
        ...
        $_header .= 'X-Mailer: ERP version ' . DOL_VERSION .' (using SMTPs Mailer)' . "\r\n";
        $_header .= 'X-ERP-Option: '.($conf->global->MAIN_MAIL_USE_MULTI_PART?'MAIN_MAIL_USE_MULTI_PART':'No MAIN_MAIL_USE_MULTI_PART') . "\r\n";
    ...
    private function _setBoundary()
    {
        ...
        $this->_smtpsRelatedBoundary = 'mul_'.dol_hash(uniqid("mounir2"), 3);
        $this->_smtpsAlternativeBoundary = 'mul_'.dol_hash(uniqid("mounir3"), 3);
    }
