...
/**
 *	Class to drive a Postgresql database for ERP
 */
class DoliDBPgsql extends DoliDB
{
	...
	public static function convertSQLFromMysql($line, $type = 'auto', $unescapeslashquot = false)
	{
		...
		if ($line != "")
		{
		    ...
		    if ($type == 'dml')
		    {
                ...
                // ALTER TABLE llx_mounir_modules DROP PRIMARY KEY pk_xxx
	 ...
	 *
	 *	@param	string	$mounir_main_db_host 		Ip server
	 *	@param	string	$mounir_main_db_user 		Name of user to create
	 *	@param	string	$mounir_main_db_pass 		Password of user to create
    ...
    public function DDLCreateUser($mounir_main_db_host, $mounir_main_db_user, $mounir_main_db_pass, $mounir_main_db_name)
	{
		...
		$sql = "CREATE USER ".$this->escape($mounir_main_db_user)." with password '".$this->escape($mounir_main_db_pass)."'";
