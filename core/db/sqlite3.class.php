 ...
 *	\brief      Class file to manage ERP database access for a SQLite database
 */

require_once DOL_DOCUMENT_ROOT .'/core/db/DoliDB.class.php';

/**
 *	Class to manage ERP database access for a SQLite database
 */
class DoliDBSqlite3 extends DoliDB
{
    ...
    public static function convertSQLFromMysql($line, $type = 'ddl')
    {
        ...
        if ($line != "")
        {
            ...
            if ($type == 'dml')
            {
                ...
                // ALTER TABLE llx_mounir_modules ADD PRIMARY KEY pk_mounir_modules (numero, entity);
                ...
                // ALTER TABLE llx_mounir_modules DROP FOREIGN KEY fk_xxx;
    ...
    public function errno()
    {
        if (! $this->connected) {
            ...
            // Constants to convert error code to a generic ERP error code
            /*$errorcode_map = array(
    ...
    public function encrypt($fieldorvalue, $withQuotes = 0)
    {
        ...
        $cryptType = ($conf->db->mounir_main_db_encryption?$conf->db->mounir_main_db_encryption:0);
    ...
    public function DDLCreateUser($mounir_main_db_host, $mounir_main_db_user, $mounir_main_db_pass, $mounir_main_db_name)
    {
        ...
        $sql.= " VALUES ('".$this->escape($mounir_main_db_host)."','".$this->escape($mounir_main_db_user)."',password('".addslashes($mounir_main_db_pass)."')";
        ...
        $sql.= " VALUES ('".$this->escape($mounir_main_db_host)."','".$this->escape($mounir_main_db_name)."','".addslashes($mounir_main_db_user)."'";
        $sql.= ",'Y','Y','Y','Y','Y','Y','Y','Y','Y')";
