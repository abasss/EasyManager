...
if ($action == 'create')
{
    ...
    $doleditor = new DolEditor('note_public', GETPOST('note_public', 'alpha'), '', 200, 'mounir_notes', 'In', false, true, true, ROWS_8, '90%');
    ...
    if (empty($user->societe_id))
    {
        ...
        $doleditor = new DolEditor('note_private', GETPOST('note_private', 'alpha'), '', 200, 'mounir_notes', 'In', false, true, true, ROWS_8, '90%');
        print $doleditor->Create(1);
...
elseif ($id)
{
    ...
    if ($result > 0)
    {
        ...
        if ($action == 'edit' && $user->rights->deplacement->creer)
        {
            ...
            $doleditor = new DolEditor('note_public', $object->note_public, '', 200, 'mounir_notes', 'In', false, true, true, ROWS_8, '90%');
            print $doleditor->Create(1);
            ...
            if (empty($user->societe_id))
            {
                ...
                $doleditor = new DolEditor('note_private', $object->note_private, '', 200, 'mounir_notes', 'In', false, true, true, ROWS_8, '90%');
                print $doleditor->Create(1);
