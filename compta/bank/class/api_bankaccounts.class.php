 ...
 */
class BankAccounts extends MounirApi
{
    ...
    public function index($sortfield = "t.rowid", $sortorder = 'ASC', $limit = 100, $page = 0, $sqlfilters = '')
    {
        ...
        if (! MounirApiAccess::$user->rights->banque->lire) {
    ...
    {
        if (! MounirApiAccess::$user->rights->banque->configurer) {
            throw new RestException(401);
        }
    ...
    {
        if (! MounirApiAccess::$user->rights->banque->modifier) {
            throw new RestException(401);
        }
