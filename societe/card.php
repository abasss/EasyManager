		...
		else
		{
			...
			if (!$error)
			{
					...
					|| $soc_origin->barcode == $object->barcode)
				{
					...
					$soc_origin->code_client = 'C-';
					$soc_origin->code_fournisseur = 'F-';
					$soc_origin->barcode = '';
...
else
{
    ...
    if ($action == 'create')
    {
		...
		if (GETPOST("type")==''){
		  ...
		  if (GETPOST("type")=='p'){
		  print load_fiche_titre($langs->trans("MenuNewProspect"), $linkback, 'title_companies.png');
		  }
		  if (GETPOST("type")=='c'){
		  print load_fiche_titre($langs->trans("MenuNewCustomer"), $linkback, 'title_companies.png');
		  }
		  if (GETPOST("type")=='f'){
		  print load_fiche_titre($langs->trans("MenuNewSupplier"), $linkback, 'title_companies.png');
		  }
...
/**********************************************************************************************************************************************************************************************************************************************************************************************************/		
        ...
        else
		{
		  ...
		  if (GETPOST("type")=='p'){
		    print '<span id="TypeName" class="fieldrequired">'.$form->editfieldkey('MenuNewProspect', 'name', '', $object, 0).'</span>';
		  }
		  if (GETPOST("type")=='c'){
		    print '<span id="TypeName" class="fieldrequired">'.$form->editfieldkey('MenuNewCustomer', 'name', '', $object, 0).'</span>';
		  }
		  if (GETPOST("type")=='f'){
		    print '<span id="TypeName" class="fieldrequired">'.$form->editfieldkey('MenuNewSupplier', 'name', '', $object, 0).'</span>';
		  }
        }
		...
		//if (GETPOST("type")!='f'){
		//echo "Abass : "; print GETPOST("type");echo "<br>";
/**********************************************************************************************************************************************************************************************************************************************************************************************************/
/**********************************************************************************************************************************************************************************************************************************************************************************************************/		
	if (GETPOST("type")=='c'){
        print '<tr><td class="titlefieldcreate">'.$form->editfieldkey('Customer', 'customerprospect', '', $object, 0, 'string', '', 1).'</td>';
	    print '<td class="maxwidthonsmartphone">';
	    $selected=(GETPOSTISSET('client', 'int')?GETPOST('client', 'int'):$object->client);
		//echo "Abass : "; print $selected; echo "<br>";
		$selected=1;
	...
	if (GETPOST("type")=='p'){
        print '<tr><td class="titlefieldcreate">'.$form->editfieldkey('Prospect', 'customerprospect', '', $object, 0, 'string', '', 1).'</td>';
	    print '<td class="maxwidthonsmartphone">';
	    $selected=(GETPOSTISSET('client', 'int')?GETPOST('client', 'int'):$object->client);
	    print $formcompany->selectProspectCustomerType($selected);
	    print '</td>';
