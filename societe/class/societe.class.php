...
class Societe extends CommonObject
{
    ...
    public function create(User $user)
	{
		...
		// For automatic creation during create action (not used by ERP GUI, can be used by scripts)
	 ...
	 *    @param    string	$ref_ext       	External reference of third party (Warning, this information is a free field not provided by ERP)
	 *    @param    string	$ref_int       	Internal reference of third party (not used by mounir)
