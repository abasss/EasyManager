 ...
 *      \ingroup    usergroup
 *      \brief      Fiche de notes sur un utilisateur ERP
 */
...
if ($id)
{
	...
	if ($action == 'edit' && $user->rights->user->user->creer)
	{
		...
		$doleditor=new DolEditor('note_private', $object->note, '', 280, 'mounir_notes', 'In', true, false, $conf->global->FCKEDITOR_ENABLE_SOCIETE, ROWS_8, '90%');
		$doleditor->Create();
	}
	else
	{
