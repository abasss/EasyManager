...
print '<tr '.$bc[0].'><td width="300">'.$langs->trans("Password").'</td><td>'.preg_replace('/./i', '*', $mounir_main_db_pass).'</td></tr>'."\n";
...
else
{
	foreach($arraylist as $listname)
	{
		...
		{
			$arraytest=array(
				'character_set_database'=>array('var'=>'mounir_main_db_character_set','valifempty'=>'utf8'),
				'collation_database'=>array('var'=>'mounir_main_db_collation','valifempty'=>'utf8_unicode_ci')
			);
		}
