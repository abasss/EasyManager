 ...
 *		\brief      Page to show all ERP setup (config file and database constants)
 */
...
$configfileparameters=array(
							'mounir_main_url_root',
							'mounir_main_url_root_alt',
							'mounir_main_document_root',
							'mounir_main_document_root_alt',
							'mounir_main_data_root',
							'separator',
							'mounir_main_db_host',
							'mounir_main_db_port',
							'mounir_main_db_name',
							...
							'mounir_main_db_user',
							'mounir_main_db_pass',
							'mounir_main_db_character_set',
							'mounir_main_db_collation',
							'?mounir_main_db_prefix',
							'separator',
							'mounir_main_authentication',
							'separator',
							'?mounir_main_auth_ldap_login_attribute',
							'?mounir_main_auth_ldap_host',
							'?mounir_main_auth_ldap_port',
							'?mounir_main_auth_ldap_version',
							'?mounir_main_auth_ldap_dn',
							'?mounir_main_auth_ldap_admin_login',
							'?mounir_main_auth_ldap_admin_pass',
							'?mounir_main_auth_ldap_debug',
                            'separator',
							...
							'separator',
							'?mounir_mailing_limit_sendbyweb',
							'?mounir_mailing_limit_sendbycli',
                            '?mounir_strict_mode'
						);
$configfilelib=array(
//					'separator',
...
foreach($configfileparameters as $key)
{
	...
	if ($key == 'mounir_main_url_root_alt' && empty(${$key})) $ignore=1;
	if ($key == 'mounir_main_document_root_alt' && empty(${$key})) $ignore=1;
