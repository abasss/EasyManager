...
print load_fiche_titre($langs->trans("PerfMounir"), '', 'title_setup');

print $langs->trans("YouMayFindPerfAdviceHere", 'https://www.google.com/index.php/FAQ_Increase_Performance').' (<a href="'.$_SERVER["PHP_SELF"].'">'.$langs->trans("Reload").'</a>)<br>';
