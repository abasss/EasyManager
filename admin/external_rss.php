...
*/
		...
		$result1=mounir_set_const($db, "EXTERNAL_RSS_TITLE_" . GETPOST("norss", 'int'), GETPOST($external_rss_title, 'alpha'), 'chaine', 0, '', $conf->entity);
		if ($result1) $result2=mounir_set_const($db, "EXTERNAL_RSS_URLRSS_" . GETPOST("norss", 'int'), GETPOST($external_rss_urlrss, 'alpha'), 'chaine', 0, '', $conf->entity);
...
if ($_POST["delete"])
{
    if (GETPOST("norss", 'int'))
    {
		...
		$result1=mounir_del_const($db, "EXTERNAL_RSS_TITLE_".GETPOST("norss", 'int'), $conf->entity);
		if ($result1) $result2=mounir_del_const($db, "EXTERNAL_RSS_URLRSS_".GETPOST("norss", 'int'), $conf->entity);
...
print '<td>http://news.google.com/news?ned=us&topic=h&output=rss<br>http://www.google.com/rss</td>';
print '</tr>';
print '</table>';
