...
if ($action == 'updateMask')
{
    ...
    if ($maskconstpayment) $res = mounir_set_const($db, $maskconstpayment, $maskpayment, 'chaine', 0, '', $conf->entity);
...
if ($action == 'setmod')
{
    mounir_set_const($db, "PAYMENT_ADDON", $value, 'chaine', 0, '', $conf->entity);
}
...
if ($action == 'setparams')
{
	...
	$res = mounir_set_const($db, "FACTURE_PAYMENTS_ON_DIFFERENT_THIRDPARTIES_BILLS", $freetext, 'chaine', 0, '', $conf->entity);
