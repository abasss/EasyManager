...
elseif ($action == 'set')
{
	...
	{
		mounir_set_const($db, 'EXPENSEREPORT_ADDON_PDF', $value, 'chaine', 0, '', $conf->entity);
	}
}
...
elseif ($action == 'del')
{
	...
	if ($ret > 0)
	{
        if ($conf->global->EXPENSEREPORT_ADDON_PDF == "$value") mounir_del_const($db, 'EXPENSEREPORT_ADDON_PDF', $conf->entity);
	}
}
...
{
	if (mounir_set_const($db, "EXPENSEREPORT_ADDON_PDF", $value, 'chaine', 0, '', $conf->entity))
	{
...
elseif ($action == 'setmod')
{
	...
	mounir_set_const($db, "EXPENSEREPORT_ADDON", $value, 'chaine', 0, '', $conf->entity);
}
...
elseif ($action == 'setoptions')
{
	...
	$res1 = mounir_set_const($db, "EXPENSEREPORT_FREE_TEXT", $freetext, 'chaine', 0, '', $conf->entity);

	$draft= GETPOST('EXPENSEREPORT_DRAFT_WATERMARK', 'alpha');
	$res2 = mounir_set_const($db, "EXPENSEREPORT_DRAFT_WATERMARK", trim($draft), 'chaine', 0, '', $conf->entity);
