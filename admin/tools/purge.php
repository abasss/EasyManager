...
print $langs->trans("PurgeAreaDesc", $mounir_main_data_root).'<br>';
print '<br>';
...
if (! empty($conf->syslog->enabled))
{
	...
	if ($user->admin && preg_match('/^mounir.*\.log$/', basename($filelog)))
	{
...
print '> '.$langs->trans("PurgeDeleteAllFilesInDocumentsDir", $mounir_main_data_root).'<br>';
