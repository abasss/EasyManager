...
elseif (in_array($compression, array('gz', 'bz')))
{
    ...
    $cmd = "tar -cf ".$outputdir."/".$file." --exclude-vcs --exclude 'temp' --exclude 'brs.log' --exclude='documents/admin/documents' -C ".dirname(DOL_DATA_ROOT)." ".basename(DOL_DATA_ROOT);
...
header("Location: mounir_export.php");
