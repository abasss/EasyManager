...
/**
 *		\file 		htdocs/admin/tools/mounir_export.php
 *		\ingroup	core
...
<?php
print $langs->trans("BackupDesc3", $mounir_main_db_name).'<br>';
...
print $langs->trans("DatabaseName").' : <b>'.$mounir_main_db_name.'</b><br>';
print '</td>';
print '</tr>';
...
{
	print '<br><font class="warning">'.$langs->trans("YouMustRunCommandFromCommandLineAfterLoginToUser", $mounir_main_db_user, $mounir_main_db_user).':</font><br>'."\n";
