...
elseif ($action == 'del_default')
{
	...
	if ($ret > 0)
	{
        if ($conf->global->USERGROUP_ADDON_PDF_ODT == "$value") mounir_del_const($db, 'USERGROUP_ADDON_PDF_ODT', $conf->entity);
	}
	$res = true;
}
...
{
	if (mounir_set_const($db, "USERGROUP_ADDON_PDF_ODT", $value, 'chaine', 0, '', $conf->entity))
	{
