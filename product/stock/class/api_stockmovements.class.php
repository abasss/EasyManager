 ...
 */
class StockMovements extends MounirApi
{
    /**
    ...
    public function get($id)
    {
        ...
        if( ! MounirApi::_checkAccessToResource('warehouse',$this->stockmovement->id)) {
    ...
    public function post($request_data = null)
    {
        ...
        if($this->stockmovement->_create(MounirApiAccess::$user, $product_id, $warehouse_id, $qty, $type, $price, $movementlabel, $movementcode, '', '', '', $lot) <= 0) {
    ...
    public function put($id, $request_data = null)
    {
        ...
        if( ! MounirApi::_checkAccessToResource('stock',$this->stockmovement->id)) {
            throw new RestException(401, 'Access not allowed for login '.MounirApiAccess::$user->login);
        }
        ...
        if($this->stockmovement->update($id, MounirApiAccess::$user))
            return $this->get ($id);
    ...
    public function delete($id)
    {
        ...
        if (! $this->stockmovement->delete(MounirApiAccess::$user)) {
