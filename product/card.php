...
else
{
	...
	if ($action == 'create' && $usercancreate)
    {
        ...
        $doleditor = new DolEditor('desc', GETPOST('desc', 'none'), '', 160, 'mounir_details', '', false, true, $conf->global->FCKEDITOR_ENABLE_PRODUCTDESC, ROWS_4, '90%');
        $doleditor->Create();
...
*/
        ...
        //{
            ...
            // We use mounir_details as type of DolEditor here, because we must not accept images as description is included into PDF and not accepted by TCPDF.
            $doleditor = new DolEditor('note_private', GETPOST('note_private', 'none'), '', 140, 'mounir_details', '', false, true, $conf->global->FCKEDITOR_ENABLE_PRODUCTDESC, ROWS_8, '90%');
    	    $doleditor->Create();
...
*/
    ...
    elseif ($object->id > 0)
    {
		...
		if ($action == 'edit' && $usercancreate)
		{
            ...
            // We use mounir_details as type of DolEditor here, because we must not accept images as description is included into PDF and not accepted by TCPDF.
            $doleditor = new DolEditor('desc', $object->description, '', 160, 'mounir_details', '', false, true, $conf->global->FCKEDITOR_ENABLE_PRODUCTDESC, ROWS_4, '90%');
            $doleditor->Create();
...
*/
			...
			// {
                ...
                // $doleditor = new DolEditor('note_private', $object->note_private, '', 140, 'mounir_notes', '', false, true, $conf->global->FCKEDITOR_ENABLE_PRODUCTDESC, ROWS_4, '90%');
                // $doleditor->Create();
