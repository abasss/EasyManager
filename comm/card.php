...
if ($object->id > 0)
{
	...
	*/
    ...
    if (! empty($conf->adherent->enabled))
    {
        ...
        print '<tr><td class="titlefield">'.$langs->trans("LinkedToMounirMember").'</td>';
        print '<td>';
        $adh=new Adherent($db);
	...
	$boxstat.='<table summary="'.dol_escape_htmltag($langs->trans("MounirStateBoard")).'" class="border boxtable boxtablenobottom boxtablenotop" width="100%">';
