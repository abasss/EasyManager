 ...
 * 				http://127.0.0.1/mounir/public/agenda/agendaexport.php?format=vcal&exportkey=cle
 * 				http://127.0.0.1/mounir/public/agenda/agendaexport.php?format=ical&type=event&exportkey=cle
 * 				http://127.0.0.1/mounir/public/agenda/agendaexport.php?format=rss&exportkey=cle
...
if ($shortfilename=='mounircalendar')
{
	$langs->load("main");
	$langs->load("errors");
	llxHeaderVierge();
