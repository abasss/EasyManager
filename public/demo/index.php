...
// Security check
global $mounir_main_demo;
if (empty($mounir_main_demo)) accessforbidden('Parameter mounir_main_demo must be defined in conf file with value "default login,default pass" to enable the demo entry page', 0, 0, 1);
...
if (empty($reshook))
{
	$demoprofiles=array(
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/mounir_screenshot8.png',
		...
		'icon'=>DOL_URL_ROOT.'/public/demo/mounir_screenshot2.png',
		'url'=>$url
		),
		...
		'icon'=>DOL_URL_ROOT.'/public/demo/mounir_screenshot6.png',
		'url'=>$url
		),
	    ...
	    //'icon'=>DOL_URL_ROOT.'/public/demo/mounir_screenshot9.png'
...
$head.='<meta name="description" content="ERP ERP and CRM demo. You can test here several profiles for ERP ERP and CRM demonstration.">'."\n";
...
llxHeaderVierge($langs->trans("MounirDemo"), $head);
...
print '<a alt="Official portal of your ERP CRM application" targe="_blank" href="https://www.google.com"><img class="demologo" src="'.DOL_URL_ROOT.'/theme/mounir_logo.png" alt="ERP logo"></a>';
print '</div>';
print '</div>';
...
foreach ($demoprofiles as $profilearray)
{
	if ($profilearray['default'] >= 0)
	{
		...
		// Should work with DOL_URL_ROOT='' or DOL_URL_ROOT='/mounir'
        ...
        print '<div id="div'.$profilearray['key'].'" summary="ERP online demonstration for profile '.$profilearray['label'].'" class="center inline-block CTable CTableRow'.($i%2==0?'1':'0').'">'."\n";
