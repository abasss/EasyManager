 ...
 */
class Subscriptions extends MounirApi
{
    /**
    ...
    public function post($request_data = null)
    {
        ...
        if ($subscription->create(MounirApiAccess::$user) < 0) {
    ...
    public function put($id, $request_data = null)
    {
        ...
        if ($subscription->update(MounirApiAccess::$user) > 0)
        {
            return $this->get($id);
        }
        else
    ...
    public function delete($id)
    {
        ...
        if (! $subscription->delete(MounirApiAccess::$user)) {
