 ...
 */
class MembersTypes extends MounirApi
{
    /**
    ...
    public function get($id)
    {
        ...
        if( ! MounirApi::_checkAccessToResource('member', $membertype->id, 'adherent_type')) {
    ...
    {
        if (! MounirApiAccess::$user->rights->adherent->configurer) {
            throw new RestException(401);
        }
        ...
        if ($membertype->create(MounirApiAccess::$user) < 0) {
    ...
    public function put($id, $request_data = null)
    {
        ...
        if ($membertype->update(MounirApiAccess::$user) >= 0)
        {
            return $this->get($id);
        }
        else
