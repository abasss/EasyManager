...
if ($action == 'updateall')
{
    ...
    $res1=mounir_set_const($db, 'XXXX', GETPOST('ADHERENT_LOGIN_NOT_REQUIRED', 'alpha'), 'chaine', 0, '', $conf->entity);
...
if ($action == 'update' || $action == 'add')
{
	...
	$res=mounir_set_const($db, $constname, $constvalue, $typetouse, 0, $constnote, $conf->entity);
