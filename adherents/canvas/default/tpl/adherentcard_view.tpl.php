...
<tr>
	<td><?php echo $langs->trans("MounirLogin"); ?></td>
	<td colspan="3"><?php echo $this->control->tpl['mounir_user']; ?></td>
</tr>
...
<a class="butAction" href="<?php echo $_SERVER["PHP_SELF"].'?id='.$this->control->tpl['id'].'&amp;action=create_user&amp;canvas='.$canvas; ?>"><?php echo $langs->trans("CreateMounirLogin"); ?></a>
<?php } ?>
