...
$conf_db_type = $mounir_main_db_type;

// Parametres de connexion a la base
$conf_db_host = $mounir_main_db_host;
$conf_db_user = $mounir_main_db_user;
$conf_db_pass = $mounir_main_db_pass;
$conf_db_base = $mounir_main_db_name;

// Identifiant unique correspondant au personne generique pour la vente
