 ...
 */
class Interventions extends MounirApi
{
    ...
    {
        if(! MounirApiAccess::$user->rights->ficheinter->lire) {
        ...
        if( ! MounirApi::_checkAccessToResource('fichinter', $this->fichinter->id)) {
    ...
    {
        if(! MounirApiAccess::$user->rights->ficheinter->creer) {
        ...
        if ($this->fichinter->create(MounirApiAccess::$user) < 0) {
    ...
    */
    ...
    {
        if(! MounirApiAccess::$user->rights->ficheinter->supprimer) {
            throw new RestException(401);
        }
        $result = $this->fichinter->fetch($id);
        if( ! $result ) {
        ...
        if( ! $this->fichinter->delete(MounirApiAccess::$user)) {
    ...
    public function validate($id, $notrigger = 0)
    {
        ...
        $result = $this->fichinter->setValid(MounirApiAccess::$user, $notrigger);
        if ($result == 0) {
