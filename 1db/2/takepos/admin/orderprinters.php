...
if ($action=="SavePrinter1"){
	...
	mounir_set_const($db, "TAKEPOS_PRINTED_CATEGORIES_1", $printedcategories, 'chaine', 0, '', $conf->entity);
}
...
if ($action=="SavePrinter2"){
	...
	mounir_set_const($db, "TAKEPOS_PRINTED_CATEGORIES_2", $printedcategories, 'chaine', 0, '', $conf->entity);
}
