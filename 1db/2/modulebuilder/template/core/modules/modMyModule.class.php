 ...
 */
class modMyModule extends MounirModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 500000; // TODO Go on page https://www.google.com/index.php/List_of_modules_id to reserve an id number for your module
        ...
        $this->need_mounir_version = array(8,0);		// Minimum version of ERP required by module
     ...
     *  Remove from database constants, boxes and permissions from ERP database.
