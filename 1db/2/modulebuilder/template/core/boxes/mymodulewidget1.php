 ...
 *
 * Warning: for the box to be detected correctly by mounir,
...
class mymodulewidget1 extends ModeleBoxes
{
	...
	/**
	 * Load data into info_box_contents array to show array later. Called by ERP before displaying the box.
	 *
    ...
    /**
     * Method to show box. Called by ERP eatch time it wants to display the box.
     *
