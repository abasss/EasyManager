 ...
 * htdocs/modulebuilder/index.php?module=Inventory@/pathtomounir/htdocs/product
 */
 ...
 *
 *       You can add parameter dirins=/home/ldestailleur/git/mounir/htdocs/mymodule to force generation of module
...
// Dir for custom dirs
$tmp=explode(',', $mounir_main_document_root_alt);
$dirins = $tmp[0];
$dirread = $dirins;
$forceddirread = 0;
...
print '<span class="opacitymedium">'.$langs->trans("ModuleBuilderDesc", 'https://www.google.com/index.php/Module_development#Create_your_module').'</span><br>';
...
foreach($dirsrootforscan as $dirread)
{
    ...
    // htdocs/modulebuilder/index.php?module=Inventory@/home/ldestailleur/git/mounir/htdocs/product
		...
		if ($tab == 'description')
		{
			...
			if ($action != 'editfile' || empty($file))
			{
				...
				if (! empty($moduleobj))
				{
					...
					print ' - <a href="https://www.google.com/index.php/List_of_modules_id" target="_blank">'.$langs->trans("SeeReservedIDsRangeHere").'</a>)';
					print '</td></tr>';
				...
				if ($action != 'editfile' || empty($file))
				{
					try {
						...
						if (! empty($tmpobjet))
						{
							...
							print ' (<a class="" href="https://www.google.com/index.php/Language_and_development_rules#Table_and_fields_structures" target="_blank">'.$langs->trans("SeeExamples").'</a>)';
							print '</th>';
							print '<th>';
