...
if ($action == 'create')
{
    ...
    if ($origin)
    {
        ...
        if ($object->fetch($origin_id))	// This include the fetch_lines
        {
            ...
            print '<td colspan="3">';
            $doleditor = new DolEditor('note_public', $object->note_public, '', 60, 'mounir_notes', 'In', 0, false, true, ROWS_3, '90%');
            ...
            if ($object->note_private && ! $user->societe_id)
            {
                ...
                print '<td colspan="3">';
                $doleditor = new DolEditor('note_private', $object->note_private, '', 60, 'mounir_notes', 'In', 0, false, true, ROWS_3, '90%');
        		print $doleditor->Create(1);
                print "</td></tr>";
            }
