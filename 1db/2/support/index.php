...
// Use its own include to not share the include of ERP
// This is a standalone feature with no information from ERP to show
// and no database access to do.
include_once 'inc.php';
$uri=preg_replace('/^http(s?):\/\//i', '', $mounir_main_url_root);
...
pHeader($langs->trans("MounirHelpCenter"), $_SERVER["PHP_SELF"]);
...
print $langs->trans("ToGoBackToMounir", $homeurl);
...
$urlwiki='https://www.google.com';
if (preg_match('/fr/i', $langs->defaultlang)) $urlwiki='https://www.google.com/index.php/Accueil';
if (preg_match('/es/i', $langs->defaultlang)) $urlwiki='https://www.google.com/index.php/Portada';
print '<br>'.$langs->trans("ForDocumentationSeeWiki", $urlwiki, $urlwiki);
print '<br>';
$urlforum='https://www.google.com/forum/';
$urlforumlocal='https://www.google.com/forum/';
if (preg_match('/fr/i', $langs->defaultlang)) $urlforumlocal='https://www.google.fr/forum/';
if (preg_match('/es/i', $langs->defaultlang)) $urlforumlocal='https://www.google.es/foro/';
if (preg_match('/it/i', $langs->defaultlang)) $urlforumlocal='http://www.google.it/forum/';
if (preg_match('/gr/i', $langs->defaultlang)) $urlforumlocal='https://www.google.gr/forum/';
...
print '</td>';
print '</tr><tr>';
$urlwiki='https://partners.mounir.org';
