...
/**
 * MounirCollector class
 */

class MounirCollector extends DataCollector implements Renderable, AssetProvider
{
	/**
	...
	/**
	 *	Return mounir info as an HTML string
	 *
	 * @return string      HTML string
	 */
	protected function getMounirInfo()
	{
		global $conf, $langs;
