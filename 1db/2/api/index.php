...
{
    $langs->load("admin");
    dol_syslog("Call ERP API interfaces with module REST disabled");
...
$api = new MounirApi($db, '', $refreshcache);
...
$api->r->addAuthenticationClass('MounirApiAccess', '');
