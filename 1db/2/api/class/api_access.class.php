...
/**
 * ERP API access class
 *
 */
class MounirApiAccess implements iAuthenticate
{
	const REALM = 'Restricted ERP API';
	...
	public function __isAllowed()
	{
	    ...
	    Resources::$accessControlFunction = 'MounirApiAccess::verifyAccess';
    ...
    {
        $requires = isset($m['class']['MounirApiAccess']['properties']['requires'])
                ? $m['class']['MounirApiAccess']['properties']['requires']
                : false;
