...
class Ticket extends CommonObject
{
    ...
    /**
     * @var int Notify personne at create
     */
    ...
    {
        global $conf, $langs, $mysoc, $mounir_main_url_root;
        ...
        if ($result) {
            ...
            while ($i < $num) { // For each notification couple defined (third party/actioncode)
                ...
                if (dol_strlen($sendto))
                {
                    ...
                    $application = ($conf->global->MAIN_APPLICATION_TITLE ? $conf->global->MAIN_APPLICATION_TITLE : 'ERP ERP/CRM');

                    $subject = '[' . $application . '] ' . $langs->transnoentitiesnoconv("MounirNotification");
