...
if ($action == 'create')
{
	...
	$doleditor=new DolEditor('note_public', $note_public, '', '100', 'mounir_notes', 'In', 1, true, true, ROWS_3, '90%');
	...
	if (empty($user->societe_id))
	{
		...
		$doleditor=new DolEditor('note_private', $note_private, '', '100', 'mounir_notes', 'In', 1, true, true, ROWS_3, '90%');
		print $doleditor->Create(1);
		print '</td></tr>';
	}
		...
		while ($cursorline <= $nbofservices)
		{
			...
			if ($result)
			{
				...
				else
				{
					...
					$doleditor=new DolEditor('product_desc', $objp->description, '', 92, 'mounir_details', '', false, true, $enable, $nbrows, '90%');
					$doleditor->Create();
