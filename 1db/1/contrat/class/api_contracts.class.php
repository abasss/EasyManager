 ...
 */
class Contracts extends MounirApi
{
    ...
    {
        if(! MounirApiAccess::$user->rights->contrat->lire) {
        ...
        if( ! MounirApi::_checkAccessToResource('contrat', $this->contract->id)) {
    ...
    {
        if(! MounirApiAccess::$user->rights->contrat->creer) {
        ...
        if ($this->contract->create(MounirApiAccess::$user) < 0) {
    ...
    public function activateLine($id, $lineid, $datestart, $dateend = null, $comment = null)
    {
        ...
        $updateRes = $this->contract->active_line(MounirApiAccess::$user, $lineid, $datestart, $dateend, $comment);
    ...
    public function unactivateLine($id, $lineid, $datestart, $comment = null)
    {
        ...
        $updateRes = $this->contract->close_line(MounirApiAccess::$user, $lineid, $datestart, $comment);
    ...
    public function deleteLine($id, $lineid)
    {
        ...
        $updateRes = $this->contract->deleteline($lineid, MounirApiAccess::$user);
        if ($updateRes > 0) {
            return $this->get($id);
        }
        else
    ...
    public function put($id, $request_data = null)
    {
        ...
        if ($this->contract->update(MounirApiAccess::$user) > 0)
        {
            return $this->get($id);
        }
        else
    ...
    {
        if (! MounirApiAccess::$user->rights->contrat->supprimer) {
            throw new RestException(401);
        }
        $result = $this->contract->fetch($id);
        if (! $result) {
        ...
        if (! $this->contract->delete(MounirApiAccess::$user)) {
    ...
    public function validate($id, $notrigger = 0)
    {
        ...
        $result = $this->contract->validate(MounirApiAccess::$user, '', $notrigger);
        if ($result == 0) {
    ...
    public function close($id, $notrigger = 0)
    {
        ...
        $result = $this->contract->closeAll(MounirApiAccess::$user, $notrigger);
        if ($result == 0) {
