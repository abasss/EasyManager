...
/**
 * \file scripts/user/sync_users_ldap2mounir.php
 * \ingroup ldap member
 * \brief Script to update users into ERP from LDAP
 */
...
if (empty($conf->global->LDAP_USER_DN)) {
	print $langs->trans("Error") . ': ' . $langs->trans("LDAP setup for users not defined inside ERP");
	exit(- 1);
}
