...
# ERP variable MAIN_ODT_AS_PDF must be defined 
...
# ERP variable MAIN_DOL_SCRIPTS_ROOT must be defined to path of script directories (otherwise mounir will try to guess).
