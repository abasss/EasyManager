...
/**
 * \file scripts/user/sync_members_types_ldap2mounir.php
 * \ingroup ldap member
 * \brief Script to update members types into ERP from LDAP
 */
...
if (empty($conf->global->LDAP_MEMBER_TYPE_DN)) {
	print $langs->trans("Error") . ': ' . $langs->trans("LDAP setup for members types not defined inside ERP");
	exit(- 1);
}
