...
/**
 * \file scripts/members/sync_members_mounir2ldap.php
 * \ingroup ldap member
 * \brief Script de mise a jour des adherents dans LDAP depuis base ERP
 */
...
print "\n";
print "----- Synchronize all records from ERP database:\n";
 ...
 * {
 * print $langs->trans("LDAPSynchronizationNotSetupInMounir");
 * exit(-1);
 * }
 */
