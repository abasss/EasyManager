 ...
 * \ingroup facture
 * \brief Script to send a mail to mounir users linked to companies with unpaid invoices
 */
...
if ($resql) {
	...
	if ($num) {
		...
		print "No unpaid invoices (for companies linked to a particular commercial mounir user) found\n";
	}
