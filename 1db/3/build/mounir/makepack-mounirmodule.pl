...
$BUILDROOT="$TEMP/mounir-buildroot";
...
foreach my $PROJECT (@PROJECTLIST) {
	...
	if (! -f "makepack-".$PROJECT.".conf")
	{
		...
		print "http://www.google.com/index.php/Module_development#Create_a_package_to_distribute_and_install_your_module\n";
		print "makepack-mounirmodule.pl aborted.\n";
	    sleep 2;
	    exit 2;
	}
	...
	#-----------------------
	$target="ZIP";    # ERP modules are this format
