...
$CONFFILE="mounir-doxygen.doxyfile";
...
if (! -s $CONFFILE)
{
    print "Error: current directory for building ERP doxygen documentation is not correct.\n";
    print "\n";
	print "Change your current directory then, to launch the script, run:\n";
	print '> perl .\mounir-doxygen-build.pl  (on Windows)'."\n";
	print '> perl ../mounir-doxygen-build.pl  (on Linux or BSD)'."\n";
    sleep 4;
    exit 1;   
}
