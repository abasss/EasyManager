...
<PADGEN_PML>
	...
	<Program_Info>
		...
		<Program_Change_Info>http://www.google.com</Program_Change_Info>
	...
	<Program_Descriptions>
		<English>
			<Keywords>doliwamp, mounir, erp, crm, invoices, commercial proposals, orders, accounting, stock, products, agenda, bank, business, company, foundation, management</Keywords>
			<Char_Desc_45>DoliWamp, ERP ERP/CRM for Windows</Char_Desc_45>
			<Char_Desc_80>DoliWamp, the easy to use ERP for Windows to manage your company,foundation</Char_Desc_80>
			<Char_Desc_250>DoliWamp is the ERP ERP/CRM for Windows, the easy to use open source software to manage your activity (invoices, customers, suppliers, contracts, agenda, emailings...) and any other things a small or mid-sized business or a foundation needs.</Char_Desc_250>
			<Char_Desc_450>DoliWamp is the ERP ERP/CRM autoinstaller for Windows users with no technical knowledge to install ERP and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file. ERP ERP/CRM is a software package built by modules addition (you enable only features you need), to manage small or mid-sized businesses, freelancers or foundations.</Char_Desc_450>
			<Char_Desc_2000>DoliWamp is the ERP ERP/CRM for Windows. ERP ERP &amp; CRM is a software built by modules addition (you enable only features you need), to manage small or mid-sized businesses, freelancers or foundations (You can manage or follow contacts, invoices, orders, commercial proposals, products, stock management, agenda, mass emailings, members of a foundation, bank accounts...). Based on a WAMP, MAMP or LAMP server (Apache, Mysql, PHP for all Operating Systems), you can install it as a standalone program or use it from anywhere with any web browser. ERP is an OpenSource project. It differs from other ERP or CRM softwares (like OpenAguila, OpenBravo, OpenERP, Neogia, Compiere, etc) because everything was made to be more simple: Simple to install, Simple to use, Simple to develop. 
DoliWamp is the auto-installer for Windows users with no technical knowledge to install ERP ERP/CRM and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file.</Char_Desc_2000>
		</English>
		<French>
			<Keywords>doliwamp, mounir, erp, crm, factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations, entreprises, PME, TPE</Keywords>
			<Char_Desc_45>DoliWamp, ERP ERP/CRM pour Windows</Char_Desc_45>
			<Char_Desc_80>DoliWamp, la distribution de ERP pour gérer votre entreprise ou association</Char_Desc_80>
			<Char_Desc_250>DoliWamp est la version spécialisée pour Windows de ERP ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_250>
			<Char_Desc_450>DoliWamp est la version spécialisée pour Windows de ERP ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_450>
			<Char_Desc_2000>DoliWamp est la version spécialisée pour Windows de ERP ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_2000>
		</French>
		<Italian>
			<Keywords>doliwamp, mounir, erp, crm, gestionale, medie imprese, fondazioni</Keywords>
			<Char_Desc_45>DoliWamp, ERP ERP/CRM per Windows</Char_Desc_45>
			<Char_Desc_80>Gestionale open source e gratuito per piccole e medie imprese, fondazioni</Char_Desc_80>
			<Char_Desc_250>ERP è un a gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività.</Char_Desc_250>
			<Char_Desc_450>ERP è un programma gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività. ERP è progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare.</Char_Desc_450>
			<Char_Desc_2000>ERP è un programma gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività. ERP è progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare. ERP è completamente web-based, progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare.</Char_Desc_2000>
		</Italian>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			<Application_Info_URL>http://www.google.com/pages/mounirwinbin.php</Application_Info_URL>
			<Application_Order_URL>http://www.google.com/pages/mounirwinbin.php</Application_Order_URL>
			<Application_Screenshot_URL>http://www.google.com/images/mounir_screenshot1.png</Application_Screenshot_URL>
			<Application_Icon_URL>http://www.google.com/images/mounir.gif</Application_Icon_URL>
			<Application_XML_File_URL>http://www.google.com/files/pad_doliwamp.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.google.com/files/doliwamp.exe</Primary_Download_URL>
			<Secondary_Download_URL>http://www.google.com/files/doliwamp.exe</Secondary_Download_URL>
