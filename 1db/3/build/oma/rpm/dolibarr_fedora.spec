...
echo Run post script of packager mounir_fedora.spec
...
semanage fcontext -a -t httpd_sys_script_rw_t "/etc/mounir(/.*?)"
semanage fcontext -a -t httpd_sys_script_rw_t "/var/lib/mounir(/.*?)"
