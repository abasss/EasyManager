...
# changes on files in its ERP tree.
# The output patch file can then be submited on ERP dev mailing-list,
...
then 
    ...
    echo Example: buildpatch.sh  /mydirA/mounirold  /mydirB/mounirnew
else
