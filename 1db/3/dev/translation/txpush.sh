...
export project='mounir'

# Syntax
if [ "x$1" = "x" ]
then
	echo "This push local files to translate for project $project."
	echo "Note:  If you push a language file (not source), file will be skipped if translate file is newer."
