...
if (empty($mounir_nocache)) header('Cache-Control: max-age=10800, public, must-revalidate');
...
.select2-container-multi-mounir .select2-choices-mounir .select2-search-choice-mounir {
...
.select2-container-multi-mounir .select2-choices-mounir .select2-search-choice-mounir a {
	font-weight: normal;
}
.select2-container-multi-mounir .select2-choices-mounir li {
  float: left;
  list-style: none;
}
.select2-container-multi-mounir .select2-choices-mounir {
  height: auto !important;
  height: 1%;
  margin: 0;
  padding: 0 5px 0 0;
