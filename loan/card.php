...
if ($action == 'create')
{
	...
	$doleditor = new DolEditor('note_private', GETPOST('note_private', 'alpha'), '', 160, 'mounir_notes', 'In', false, true, true, ROWS_6, '90%');
	...
	print '<td>';
	$doleditor = new DolEditor('note_public', GETPOST('note_public', 'alpha'), '', 160, 'mounir_notes', 'In', false, true, true, ROWS_6, '90%');
	print $doleditor->Create(1);
	print '</td></tr>';
