 ...
 */
class Supplierproposals extends MounirApi
{
    ...
    {
        if(! MounirApiAccess::$user->rights->supplier_proposal->lire) {
        ...
        if( ! MounirApi::_checkAccessToResource('supplier_proposal', $this->propal->id)) {
