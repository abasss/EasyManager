...
class EmailCollector extends CommonObject
{
    ...
    */
    ...
    public function doCollectOneCollector()
    {
        ...
        //$conf->global->SYSLOG_FILE = 'DOL_DATA_ROOT/mounir_mydedicatedlofile.log';
        ...
        if (! $error && ! empty($arrayofemail) && count($arrayofemail) > 0)
        {
            ...
            foreach($arrayofemail as $imapemail)
            {
                ...
                {
                    //if (empty($headers['X-ERP-TRACKID'])) continue;
                ...
                */
                ...
                // References: <1542377954.SMTPs-mounir-thi649@8f6014fde11ec6cdec9a822234fc557e>
                // References: <1542377954.SMTPs-mounir-tic649@8f6014fde11ec6cdec9a822234fc557e>
                // References: <1542377954.SMTPs-mounir-abc649@8f6014fde11ec6cdec9a822234fc557e>
                $trackid = '';
                $reg=array();
                if (! empty($headers['References']) && preg_match('/mounir-([a-z]+)([0-9]+)@'.preg_quote($host, '/').'/', $headers['References'], $reg))
                {
                    $trackid = $reg[1].$reg[2];
